    ...
    <div class="card-body">
        <form action="{{route('admin.update', $admin->id)}}" method="post" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="fullname" class="form-control @error('fullname') is-invalid @enderror" value="{{old('fullname', $admin->fullname)}}"
            ...
            <div class="mb-3">
                ...
                <select name="role" id="role" class="form-control @error('role') is-invalid @enderror"
                    ...
                    <option value="{{$role->name}}" {{old('role', $admin->roles[0]->id) == $role->id ?  'selected' : ''}}>{{$role->name}}</option>
                    @endforeach
