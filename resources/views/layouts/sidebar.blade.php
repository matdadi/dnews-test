@php
    use Illuminate\Support\Facades\Route;
        ...
        $isUserManagement = request()->is('admin', 'admin/*', 'role', 'role/*', 'permission', 'permission/*');
@endphp
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                @canany(['admin-read', 'role-read', 'permission-read'])
                    <li class="nav-item {{ $isUserManagement  ? 'active' : '' }}  dropdown">
                        ...
                        <div class="dropdown-menu {{  $isUserManagement  ? 'show' : '' }}">
                            @can('admin-read')
